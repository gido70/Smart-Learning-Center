...
- تلخيص علمي عربي شامل داخل المنصة دون مفتاح API، مع تغطية متوازنة لكل أجزاء المحاضرة.
- حفظ نص المحاضرة والخلاصة وإتاحتهما للبحث لاحقاً.
- تصدير اختياري منظم إلى NotebookLM.
